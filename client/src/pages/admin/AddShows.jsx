            ...
            <div className='overflow-x-auto pb-4'>
                <div className='group flex flex-wrap gap-4 mt-4 w-max'>
                    {nowPlayingMovies.map((movie) => (
                        <div key={movie._id} className={`relative max-w-40 cursor-pointer group-hover:opacity-40 hover:-
                        translate-y-1 transition-all duration-300`} onClick={() => setSelectedMovie(movie._id)}>
