        ...
        <div className='bg-primary/10 border border-primary/20 rounded-lg p-8'>
          ...
          <div className='mt-8 flex gap-4'>
            <button
              ...
              className='flex-1 px-6 py-3 bg-primary hover:bg-primary-dull rounded-md transition font-medium'
            >
              My Bookings
            </button>
            <button
              onClick={handleLogout}
              className='flex items-center gap-2 px-6 py-3 bg-red-500/20 hover:bg-red-500/30 text-red-400 rounded-md transition font-medium'
            >
