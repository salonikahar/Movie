...
const MovieCard = ({ movie }) => {
  ...
  const primaryImage = resolveImageUrl(movie.backdrop_path) || "";
  const fallbackImage = resolveImageUrl(movie.poster_path) || "";
  ...
  return (
    ...
    hover:-translate-y-1 transition duration-300 w-60'>
      ...
      <img onClick={() => { navigate(`/movies/${movie._id}`); scrollTo(0, 0) }}
        ...
        alt={movie.title} className='rounded-lg h-52 w-full object-cover 
